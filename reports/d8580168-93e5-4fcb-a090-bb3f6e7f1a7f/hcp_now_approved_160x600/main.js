...
function initAnimations() {
	...
	_isiFullTime = _isiFullHeight / 11;

	FRAME_1();

	function FRAME_1() {
		gsap.to('.banner', { duration: .3,  opacity:1 });
		gsap.to('#f1txt1', { duration: .5,  y: 80, opacity: 1, ease:'power1.out' });

		gsap.delayedCall( 2.5, FRAME_2)
	}

	function FRAME_2() {
		gsap.to(['#f1txt1', '#bgf1', '#bgf2'], { duration: .5,  y: -427, ease:'power1.out'});
		gsap.to('#f2txt1', { duration: .5, y: -244, ease:'power1.out', delay: .2 });
	...
	function FRAME_4() {
		gsap.to('#bgf3', { duration: .4, y: 499, ease:'power1.out' });
	...
	function FRAME_5() {
		gsap.to('#bgf5', { duration: .6, y: 499, ease:'power1.out' });
		gsap.to('#f4txt1', { duration: .6, opacity: 0, delay: .2 });
		gsap.to('#bg_cta', { duration: .5, y: -145, ease:'power1.out', delay: 1 });
		gsap.to('#f5txt1', { duration: .5, y: -41, delay: 1 });
		gsap.to(['#cta','#cta_arrow'], { duration: .5, opacity: 1, delay: 1.6 });
