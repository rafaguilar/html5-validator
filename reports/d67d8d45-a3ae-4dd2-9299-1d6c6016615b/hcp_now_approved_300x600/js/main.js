var _loadedImages = 0,
	_imageArray = new Array('bgf1.png','bgf3.png','bgf5.png','bgf6.png','cta_arrow.png','cta.png','f1txt1.png','f3txt1.png','f4txt1.png','f5txt1.png','logo.png'),
	_tl,
...
function initAnimations() {
	...
	function FRAME_1() {
		...
		gsap.to('#f1txt1', { duration: .4,  y: 80, opacity: 1, ease:'power1.out' });

		gsap.delayedCall( 2.5, FRAME_2)
	}

	function FRAME_2() {
		gsap.to(['#f1txt1', '#bgf1', '#bgf2'], { duration: .5,  y: -427, ease:'power1.out'/*, delay: 1.5*/ });
		gsap.to('#f2txt1', { duration: .5, y: -253, ease:'power1.out', delay: .2 });
	...
	function FRAME_3() {
		...
		gsap.to('#bgf3', { duration: .5, y: 427, ease:'power1.out' });

		gsap.delayedCall( 3, FRAME_4)
	}

	function FRAME_4() {
		gsap.to('#bgf3', { duration: .4, y: 561, ease:'power1.out' });
		gsap.to('#f3txt1', { duration: .3, opacity: 0 });
		gsap.to('#f4txt1', { duration: .5, opacity: 1, delay: .4 });
		gsap.to('#bgf5', { duration: .5, y: 64, ease:'power1.out', delay: .4 });

		gsap.delayedCall( 3.2, FRAME_5)
	}

	function FRAME_5() {
		gsap.to('#bgf5', { duration: .6, y: 561, ease:'power1.out' });
		gsap.to('#f4txt1', { duration: .6, opacity: 0, delay: .2 });
		gsap.to('#bg_cta', { duration: .5, y: -160, ease:'power1.out', delay: 1 });
